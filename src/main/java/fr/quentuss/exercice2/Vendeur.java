...
public class Vendeur extends Employe{
	...
	public Vendeur(String nom, String prenom, int age, int anneeEmbauche, float salaire) {
		super(nom, prenom, age, anneeEmbauche);
		this.salaire = salaire;
	}
	public Vendeur(String nom, String prenom, int age, int anneeEmbauche, float ca, float multiplInteret,
